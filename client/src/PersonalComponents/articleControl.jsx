...
const ArticleControl=()=>{
    ...
    let Cards=[]
     if(postData3.length!==0){Cards= postData3.map((post)=>{
        ...
        <Divider key={post.id-10000} className='divider' dashed={true}/>
        </div>
    })}
    return<div className='outside'><div className='PersonalContentInfo'>
        <div className='menu2'><Menu className='menu1' onClick={onClick2} selectedKeys={[current1]} mode="horizontal" items={items2} />
            <div style={{display:'flex',flexDirection:'row',justifyContent:'center',alignItems:'center',gap:'20px'}}>
                ...
                <RangePicker bordered={false} locale={locale} presets={rangePresets} onChange={
                (dates, dateStrings) => {
